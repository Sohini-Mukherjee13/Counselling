...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const logoDetails = [
        { alt: 'project 1', schoolName: 'D.A.V. Public School', details: 'Counselling all mental patients' },
        { alt: 'project 2', schoolName: 'POWERGRID', details: 'Details about project 2' },
        { alt: 'project 3', schoolName: 'Loreto Asansol', details: 'Details about project 3' },
        { alt: 'project 4', schoolName: "Little Angle's, New Alipore, Kolkata", details: 'Details about project 4' },
        { alt: 'project 5', schoolName: "St.Anthny's High School , Kurseong", details: 'Details about project 5' },
        { alt: 'project 6', schoolName: 'Save The Child', details: 'Details about project 6' },
        { alt: 'project 7', schoolName: 'Tamralipta School,Tamluk', details: 'Details about project 7' },
        { alt: 'project 8', schoolName: 'AUXILIUM CONVENT , Kolkata', details: 'Details about project 8' },
        { alt: 'project 9', schoolName: 'EkTara', details: 'Details about project 9' },
        { alt: 'project 10', schoolName: 'Ojas Public School', details: 'Details about project 10' },
        { alt: 'project 11', schoolName: 'National Law University , Odhisa', details: 'Details about project 11' },
        { alt: 'project 12', schoolName: 'Our Lady Queen of the Mission , Kolkata', details: 'Details about project 12' },
        { alt: 'project 13', schoolName: 'Martin Luther University , Shillong', details: 'Details about project 13' },
        { alt: 'project 14', schoolName: 'Don Bosco,Park Circus', details: 'Details about project 14' },
        { alt: 'project 15', schoolName: 'Carmel High School', details: 'something' },
        { alt: 'project 16', schoolName: "St. Arnold's Convent School", details: 'Details about project 16' },
        { alt: 'project 17', schoolName: 'R.V.S Academy', details: 'Details about project 17' },
        { alt: 'project 18', schoolName: "St. Joseph's School , Ambari", details: 'Details about project 18' },
    ];
